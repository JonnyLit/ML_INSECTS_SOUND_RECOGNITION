...
def make_random(queen_absent_dir, queen_present_newly_accepted_dir, queen_present_original_dir, queen_present_rejected_dir, n_chunks, mode):
    """
    queen_nq = []
    features_nq = []
    ...
    X_train = np.concatenate((X_queen_absent_train, X_queen_present_newly_accepted_train, X_queen_present_original_train, X_queen_present_rejected_train))
    X_test = np.concatenate((X_queen_absent_test, X_queen_present_newly_accepted_test, X_queen_present_original_test, X_queen_present_rejected_test))
    Y_train = np.concatenate((Y_queen_absent_train, Y_queen_present_newly_accepted_train, Y_queen_present_original_train, Y_queen_present_rejected_train))
    Y_test = np.concatenate((Y_queen_absent_test, Y_queen_present_newly_accepted_test, Y_queen_present_original_test, Y_queen_present_rejected_test))
