...
'''
class_dict = {
    #"no_queen_present": "/home/zord/PycharmProjects/SBCM_4_classes/Dataset_SBCM/no_queen_present_1sec_PCM32"
    #"queen_accepted": "/home/zord/PycharmProjects/SBCM_4_classes/Dataset_SBCM/queen_accepted_1sec_PCM32"
    #"original_queen": "/home/zord/PycharmProjects/SBCM_4_classes/Dataset_SBCM/original_queen_1sec_PCM32"
    "queen_not_accepted": "/home/zord/PycharmProjects/SBCM_4_classes/Dataset_SBCM/queen_not_accepted_1sec_PCM32"
}
...
# Target class amount
target_class_count = 70000 # number of audio samples you want to reach in the specified folder (original + augmented)

for class_name, path in class_dict.items():
    files = os.listdir(path)
    current_count = len(files)
    print("folder: ", path)
    print("initial number of files inside the folder: ", current_count)
